...
<Steps>
  ...
  <Step title="Explore the Interactive API Docs">
    ...
    Every endpoint is documented with request/response schemas and can be exercised directly from the browser. The raw OpenAPI JSON schema is available at `http://127.0.0.1:5000/api/openapi.json`.
  </Step>
  ...
  <Step title="Make Your First API Call">
    ...
    ```bash
    curl http://127.0.0.1:5000/api/v2/system/statistics/
    ```
    ...
    ```bash
    curl http://127.0.0.1:5000/api/v2/system/heartbeat/
    ```
  ...
  <Step title="Obtain an API Token for Authenticated Requests">
    ...
    ```bash
    curl http://127.0.0.1:5000/api/v2/projects/ \
