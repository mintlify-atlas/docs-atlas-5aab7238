---
title: "Tasking Manager REST API Overview"
sidebarTitle: "Overview"
description: "HOT Tasking Manager exposes a versioned REST API at /api/v2/. Explore endpoints for projects, tasks, users, teams, organisations, campaigns, and more."
---
...
|---|---|
| `GET /api/v2/system/heartbeat/` | Health check — returns service status and latest release version. |
