...
<ParamField query="bbox" type="string" required>
  Comma-separated bounding box coordinates: `xmin,ymin,xmax,ymax`.
</ParamField>

<ParamField query="srid" type="integer" default="4326">
...
<CodeGroup>
```bash Get projects mapped by user
...
<ParamField body="interests" type="array" required>
...
<CodeGroup>
```bash Get user stats on project
