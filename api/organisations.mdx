...
| `402`  | Organisation name already exists |
...
| `403`  | User is not an org admin or the organisation still has projects/teams |
| `404`  | Organisation not found |

<Note>
  An organisation cannot be deleted while it still owns projects or teams. Remove all projects and teams first, or archive projects before attempting deletion.
</Note>
